...
export function activate(context: vscode.ExtensionContext): void {
    ...
    context.subscriptions.push(
        vscode.window.registerWebviewViewProvider('procrasticodeTools', toolsProvider, {
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('procrasticode.openPdf', (uri?: vscode.Uri) => {
            PdfViewerPanel.createOrShow(context.extensionUri, uri);
        }),

        vscode.commands.registerCommand('procrasticode.openDocx', (uri?: vscode.Uri) => {
        ...
        vscode.commands.registerCommand('procrasticode.setClaudeApiKey', async () => {
